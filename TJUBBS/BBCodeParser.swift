...
//                "\\[quote\\]([\\s\\S]+?)\\[/quote\\]":"<blockquote>$1</blockquote>",
                "\\[quote\\]([\\s\\S]+?)\\[/quote\\]":"<div style=\"padding: 10px; margin: 10px; border-radius: 3px; background-color: #eee;\">$1</div>",
                "\\[quote=(.+?)\\](.+?)\\[/quote\\]":"<div style=\"padding: 10px; margin: 10px; border-radius: 3px; background-color: #eee;\">$2</div>",
                "\\[p\\](.+?)\\[/p\\]":"<p>$1</p>",
...
//                "\\[img\\](.+?)\\[/img\\]":"<img src=\"\(base)$1\" width=\"100\" height=\"100\"/>",
                ...
                "\\[H5\\](.+?)\\[/H5\\]":"<H5>$1</H5>",
                "\\[H6\\](.+?)\\[/H6\\]":"<H6>$1</H6>",
//                "\\[QUOTE\\](.+?)\\[/QUOTE\\]":"<BLOCKQUOTE style=\"padding: 10px; margin: 10px; border-radius: 3px; background-color: #eee;\">$1</BLOCKQUOTE>",

                "\\[QUOTE\\](.+?)\\[/QUOTE\\]":"<div style=\"padding: 10px; margin: 10px; border-radius: 3px; background-color: #eee;\">$1</div>",
                "\\[QUOTE=(.+?)\\](.+?)\\[/QUOTE\\]":"<div style=\"padding: 10px; margin: 10px; border-radius: 3px; background-color: #eee;\">$2</div>",
                "\\[P\\](.+?)\\[/P\\]":"<P>$1</P>",
                "\\[P=(.+?),(.+?)\\](.+?)\\[/P\\]":"<P STYLE=\"TEXT-INDENT:$1PX;LINE-HEIGHT:$2%;\">$3</P>",
                "\\[CENTER\\](.+?)\\[/CENTER\\]":"<DIV ALIGN=\"CENTER\">$1",
