...
//        threadList = BBSCache.getTopThread()
    ...
    override func viewDidLoad() {
        ...
        let titleLabel = UILabel(text: "公告", color: .black, fontSize: 18, weight: UIFontWeightMedium)
    ...
    func refresh() {
        BBSJarvis.getAnnouce(success: { dict in
...
extension AnnounceViewController {
...
extension AnnounceViewController: UIViewControllerPreviewingDelegate {
