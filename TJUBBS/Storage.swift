...
struct Storage {
    ...
    private  static func getURL(for diretory: Directory) -> URL {
        ...
        case .group:
            // FIXME: 这里竟然会错
            return FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.TJUBBS") ?? FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first!
        }
